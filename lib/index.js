(function (global, factory) {
  ...
  function () {
    ...
    _proto.updatePagination = function updatePagination() {
      ...
      var _this$config$paginati = this.config.pagination,
          bulletClass = _this$config$paginati.bulletClass,
          bulletActiveClass = _this$config$paginati.bulletActiveClass;
