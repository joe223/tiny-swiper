...
Lightweight yet fully configurable and extensible carousel with native-like experience for the web.

Zero dependency, written in vanilla JavaScript, used for free and without any attribution. Creating touch-enabled, mobile-friendly sliders on SPA and more.
